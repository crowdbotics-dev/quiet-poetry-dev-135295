"""
Django settings for quiet_poetry_dev_135295 project.
...
ROOT_URLCONF = 'quiet_poetry_dev_135295.urls'
...
WSGI_APPLICATION = 'quiet_poetry_dev_135295.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_poetry_dev_135295 API",
    "DESCRIPTION": "API documentation for quiet_poetry_dev_135295 App",
    "VERSION": "v1",
}
